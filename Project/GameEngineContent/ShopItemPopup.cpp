...
void ShopItemPopup::PopupOn(ItemData& _Data)
{
	...
	{
		MsgAssert_Rtti<ShopItemPopup>(" - Á¸ÀçÇÏÁö ¾Ê´Â ¾ÆÀÌÅÛÀÇ µ¥ÀÌÅÍ¸¦ ÂüÁ¶ÇÏ·Á Çß½À´Ï´Ù.");
		return;
	}
	...
	case ItemGrade::Normal:
		...
		GetItemFontActor->SetText("¡¡±¸¸ÅÇÏ±â (¡¡ 50)");
	...
	case ItemGrade::Rare:
		...
		GetItemFontActor->SetText("¡¡±¸¸ÅÇÏ±â (¡¡ 100)");
		BuyKeyRender->GetTransform()->SetLocalPosition(float4(-72, 0, -1));
	...
	case ItemGrade::Unique:
		...
		GetItemFontActor->SetText("¡¡±¸¸ÅÇÏ±â (¡¡ 150)");
		BuyKeyRender->GetTransform()->SetLocalPosition(float4(-72, 0, -1));
		BuyGoldRender->GetTransform()->SetLocalPosition(float4(23, 0, -1));
		break;
	...
	case ItemGrade::Legendary:
		...
		GetItemFontActor->SetText("¡¡±¸¸ÅÇÏ±â (¡¡ 200)");
		BuyKeyRender->GetTransform()->SetLocalPosition(float4(-72, 0, -1));
		BuyGoldRender->GetTransform()->SetLocalPosition(float4(23, 0, -1));
		break;
	default:
