...
void ContentCore::ItemDataLoad()
{
	...
	// 완료
	LoadItem({.Name = "보급형 칼레온 검", .Note = "물리공격력이 20% 증가합니다.", 
	...
	// 완료
	LoadItem({.Name = "보급형 칼레온 활", .Note = "치명타 확률이 8% 증가합니다.", 
	...
	LoadItem({.Name = "빛 바랜 마석 파편", .Note = "최대 체력이 25 증가합니다.", 
		...
		.HP = 25});
	// 완료
	LoadItem({.Name = "식전 기도문", .Note = "스킬 쿨다운 속도가 40% 증가합니다.",
	...
	// 완료
	LoadItem({ .Name = "수행자의 견갑", .Note = "정신집중 속도가 40% 증가하고 #R물리공격력#E이 35% 증가합니다", 
	...
	// 완료
	LoadItem({ .Name = "수행자의 목걸이", .Note = "정신집중 속도가 40% 증가하고 #B마법공격력#E이 35% 증가합니다.", 
	...
	// 완료
	LoadItem({ .Name = "날개갑주", .Note = "받는 데미지가 35% 감소하고 스킬 쿨다운 속도가 50% 증가합니다.", 
	...
	// 완료
	LoadItem({ .Name = "사냥꾼의 나무장궁", .Note = "치명타 데미지가 35% 증가합니다.", 
	...
	// 완료
	LoadItem({ .Name = "타락 성자의 로브", .Note = "마법공격력이 50% 증가합니다.", 
	...
	// 완료
	LoadItem({ .Name = "무한의 뼈", .Note = "스킬 쿨다운 속도가 60% 증가합니다.", 
