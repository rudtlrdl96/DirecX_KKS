...
void ContentCore::ItemDataLoad()
{
	...
	LoadItem({.Name = "보급형 칼레온 검", .Note = "물리공격력이 20% 증가합니다.", .Index = 0,
	...
	LoadItem({.Name = "식전 기도문", .Note = "스킬 쿨다운 속도가 40% 증가합니다.",.Index = 4,
		...
		.SkillCoolDown = 0.4f});
	LoadItem({.Name = "죽도", .Note = "공격속도가 10% 증가합니다.", .Index = 5,
	...
	LoadItem({ .Name = "태양의 검", .Note = "물리공격력이 40% 증가합니다.", .Index = 104,
	...
	LoadItem({ .Name = "날개갑주", .Note = "받는 데미지가 35% 감소하고 스킬 쿨다운 속도가 50% 증가합니다.", .Index = 200,
		.Grade = ItemGrade::Unique, .Synergy1 = Synergy::Soar, .Synergy2 = Synergy::Rapidity,
		.DamageReduction = 0.35f, .SkillCoolDown = 0.5f});
	LoadItem({ .Name = "도적의 흑철단검", .Note = "치명타 확률이 20% 증가합니다.", .Index = 201,
	...
	LoadItem({ .Name = "타락 성자의 로브", .Note = "마법공격력이 50% 증가합니다.", .Index = 203,
	...
	LoadItem({ .Name = "무한의 뼈", .Note = "스킬 쿨다운 속도가 60% 증가합니다.", .Index = 301,
		.Grade = ItemGrade::Legendary, .Synergy1 = Synergy::ManaCycle, .Synergy2 = Synergy::Heritage,
		.SkillCoolDown = 0.3f});
	LoadItem({ .Name = "희망 절단기", .Note = "물리공격력이 100% 증가합니다. ", .Index = 302,
		.Grade = ItemGrade::Legendary, .Synergy1 = Synergy::Courage, .Synergy2 = Synergy::Misfortune,
		.MeleeAttack = 1.0f});
	LoadItem({ .Name = "실피드의 날개", .Note = "마법공격력이 100% 증가합니다.", .Index = 303,
