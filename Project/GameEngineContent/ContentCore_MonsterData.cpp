...
{
	LoadMonster({ .Name = "칼레온 신병_오프닝", .ImageName = "CarleonRecruit", .Index = 0, .Grade = MonsterArea::Opning});
	LoadMonster({ .Name = "칼레온 궁수_오프닝", .ImageName = "CarleonArcher", .Index = 1, .Grade = MonsterArea::Opning });
	...
	LoadMonster({ .Name = "숲지기", .ImageName = "GiganticEnt", .Index = 103, .Grade = MonsterArea::ForestOfHamory,
		.HP = 200, .Attack = 7});
	LoadMonster({ .Name = "칼레온 신병", .ImageName = "CarleonRecruit", .Index = 104, .Grade = MonsterArea::ForestOfHamory,
		.HP = 40, .Attack = 6});
	LoadMonster({ .Name = "칼레온 궁수", .ImageName = "CarleonArcher", .Index = 105, .Grade = MonsterArea::ForestOfHamory,
		.HP = 35, .Attack = 8});
	...
	LoadMonster({ .Name = "칼레온 암살자", .ImageName = "CarleonAssassin", .Index = 107, .Grade = MonsterArea::ForestOfHamory,
		.HP = 55, .Attack = 6});
	LoadMonster({ .Name = "화염 마도사_조화의 숲", .ImageName = "FlameWizard", .Index = 108, .Grade = MonsterArea::ForestOfHamory,
		.HP = 45, .Attack = 7});
	LoadMonster({ .Name = "빙결 마도사_조화의 숲", .ImageName = "GlacialWizard", .Index = 109, .Grade = MonsterArea::ForestOfHamory,
		.HP = 45, .Attack = 7});
