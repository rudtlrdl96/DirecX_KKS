...
private:
	const char* LevelComboText[15] = { "Opening" ,"Castle", "ForestOfHarmony", "GrandHall", "HolyCourtyard", "Shop", "Title", "Story", "EndingLogo", "MapTool", "BackgroundTool", "Debug_Battle", "Debug_Shader", "Debug_Inventory", "Debug_Physics"};
